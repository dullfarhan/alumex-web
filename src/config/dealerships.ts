...
// Sialkot→GB: IOK outer ring (Jammu south, clipped east ≤77.95°E), then angular join to GB.
export const pakistanOutline: [number, number][] = [
	...
	[75.04, 32.49], [75.32, 32.34], [75.5, 32.28], [75.92, 32.64],
	[75.81, 32.93], [76.39, 33.19], [76.76, 33.25], [76.92, 33.03],
	[77.33, 32.82], [77.7, 32.97],
	[77.82, 33.4], [77.68, 33.85], [77.88, 34.25], [77.75, 34.65],
	[77.92, 35.05], [77.9, 35.49],
	[77.55, 35.62], [77.2, 35.52], [76.8, 35.68], [76.48, 35.82],
